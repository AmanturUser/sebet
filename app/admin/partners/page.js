  ...
  <div className="row g-4">
    ...
    <div className="col-sm-12">
      <div className="bg-light rounded h-100 p-4">
        ...
        <ListPartners items={data}/>
        </div>
      </div>
    </div>
    <div className="col-sm-12 col-xl-6">
  <div className="bg-light rounded h-100 p-4">
    <h6 className="mb-4">Table</h6>
    <div className="btn-group" role="group">
                            <a href="/admin/partners/create"><button type="button" className="btn btn-success">Create</button></a>
                        </div>
                        <br></br>
                        <br></br>
