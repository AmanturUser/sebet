...
import { ip, pathImage } from "@/app/utils";
import ListCertificates from "./List";
  ...
  const [description, setDescription] = useState('')
    ...
    const [isError, setError] = useState(false)
      ...
      const createCategory = async (event) => {
        ...
        try {
          setLoading(true)
          const res = await fetch(ip+"/api/certificates", {
            method: "POST",
            headers: {
              'content-Type': 'application/json',
  ...
  <div className="sidebar pe-4 pb-3">
    <nav className="navbar bg-light navbar-light">
      ...
      <div className="navbar-nav w-100">
        ...
        <a href="/admin/certificates" className="nav-item nav-link active">
...
<h1 className="mb-4">{errorDetail}</h1>
...
<a className="btn btn-primary rounded-pill py-3 px-5" href="/admin/certificates">
Go Back
</a>
</div>
</div>
              ...
              <div className="row g-4">
                <div className="col-12">
                  ...
                  <div className="bg-light rounded h-100 p-4">
                    <h6 className="mb-4">Certificates</h6>
