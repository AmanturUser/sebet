...
export default function CreateProduct(){
    ...
    const [town, setTown] = useState('');
      ...
      const createPart = async (event) => {
        ...
        const submitData={"firstname":firstname,"lastname":lastname,"phoneNumber":phoneNumber,"email":email,"username":username,"password":password,"gender":gender,"dateOfBirth":dateOfBirth,"address":{
          'state':state,
          'town' : town
        }
        }
        ...
        <div className="row g-4">
          <div className="col-sm-12 col-xl-6">
            <div className="bg-light rounded h-100 p-4">
              <h6 className="mb-4">Create Product</h6>
          ...
          <div className="col-sm-12 col-xl-6">
            <div className="bg-light rounded h-100 p-4">
              ...
              <div className="form-floating mb-3">
                ...
                />
                <label htmlFor="floatingInput">Address State</label>
              </div>
              <div className="form-floating mb-3">
                <input
                  type="text"
                ...
                />
                <label htmlFor="floatingInput">Address Town</label>
              </div>
              <div className="m-n2">
                <button onClick={createPart} className="btn btn-primary w-100 m-2" type="button">Create</button>
                            </div>
                            </form>
