...
export default function DeliveriesCondition({ params }) {
  ...
  const createCategory = async (event) => {
    ...
    const deliveryId=params.conditionId
    const submitData = {deliveryId, minAmount, maxAmount, cost }
    console.log(JSON.stringify(submitData));
    try {
      setLoading(true)
      const res = await fetch(ip + "/api/deliveries/create-condition", {
        method: "POST",
        headers: {
  ...
  useEffect(() => {
    fetch(ip + "/api/deliveries/" + params.conditionId, {
      method: "GET",
      headers: {
        'content-Type': 'application/json',
        'Authorization': localStorage.getItem("jsonWebToken")
        ...
        <div className="content">
          ...
          <div className="container-fluid pt-4 px-4">
            ...
            <div className="col-sm-12 col-xl-6">
                ...
                <h6 className="mb-4">Deliverie</h6>
                <div className="table-responsive" align="right">
                    <table className="table text-start align-middle table-bordered table-hover mb-0">
                      ...
                      <tbody>
                        <tr key={params.conditionId}>
                          <th scope="row">{params.conditionId}</th>
                          <td>{data.targetTown}</td>
                          <td>{data.targetState}</td>
                          <td>{data.cost}</td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <br></br>
                  <h6 className="mb-4">Conditions</h6>
              ...
              <div className="col-col-sm-12 col-xl-6">
                <div className="bg-light rounded h-100 p-4">
                  <h6 className="mb-4">Create condition</h6>
                    <div className="col-sm-12">
                      <div className="bg-light rounded h-100 p-4">
                        <div className="form-floating mb-3">
                          ...
                          />
                          <label htmlFor="floatingInput">Min Amount</label>
                        </div>
                        <div className="form-floating mb-3">
                          <input
                            type="text"
                          ...
                          />
                          <label htmlFor="floatingInput">Max Amount</label>
                        </div>
                        <div className="form-floating mb-3">
                          <input
                            type="text"
